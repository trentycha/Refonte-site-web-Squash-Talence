 ...
 */
final class Version20250921101856 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE calendrier (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, horaires INT NOT NULL, statut TINYINT(1) NOT NULL, user_name VARCHAR(255) DEFAULT NULL, terrain INT DEFAULT NULL, duree INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
